...
class ParserModel(nn.Module):
    ...
    def print(self):
        ...
        print("e2hw: ", self.embed_to_hidden_weight)
        print("e2hb: ", self.embed_to_hidden_bias)
        print("h2lw: ", self.hidden_to_logits_weight)
        print("h2lb: ", self.hidden_to_logits_bias)
        print("e: ", self.embeddings)
    ...
    def embedding_lookup(self, w):
        ...
        x = torch.stack([torch.index_select(self.embeddings, 0, wvec).flatten() for wvec in w])
        ### END YOUR CODE
        return x
