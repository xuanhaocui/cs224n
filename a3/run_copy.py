...
if __name__ == "__main__":
    ...
    train(parser, train_data, dev_data, output_path, batch_size=1024, n_epochs=3, lr=0.0005)
    ...
    # parser.model.print()
    parser.model.load_state_dict(torch.load("results/20220908_175303/model.weights"))
    parser.model.print()
