if __name__ == '__main__':
    ...
    argp.add_argument('--finetune_epochs', default=10, type=int)
    argp.add_argument('--final_tokens', default=10, type=float)
    ...
    if args.function == 'pretrain':
        ...
        #                                     num_workers=4)
        train_config = trainer.TrainerConfig(max_epochs=args.finetune_epochs if pretrained else 75, batch_size=128, learning_rate=6e-4, lr_decay=True, 
                                            warmup_tokens=512*20, final_tokens=(args.final_tokens if pretrained else 75)*len(finetune_dataset)*block_size, 
                                            num_workers=2)
